...
from server.models.contact import Contact  # Assuming Contact model exists
...
# Add contacts for conversation between alice and bob
contact1 = Contact(user_id=user1.id, contact_id=user2.id, contact_name=user2.username)
storage.new(contact1)
contact2 = Contact(user_id=user2.id, contact_id=user1.id, contact_name=user1.username)
...
# Add contacts for conversation between carol and dave
contact3 = Contact(user_id=user3.id, contact_id=user4.id, contact_name=user4.username)
storage.new(contact3)
contact4 = Contact(user_id=user4.id, contact_id=user3.id, contact_name=user3.username)
storage.new(contact4)
storage.save()
sleep_after_operation()
...
# Add contacts for conversation between alice and carol
contact5 = Contact(user_id=user1.id, contact_id=user3.id, contact_name=user3.username)
storage.new(contact5)
contact6 = Contact(user_id=user3.id, contact_id=user1.id, contact_name=user1.username)
storage.new(contact6)
storage.save()
sleep_after_operation()

const EmptyChat = () => {
  return (
    <div className="lg:flex flex-col items-center justify-center h-full text-center p-6 bg-white rounded-lg shadow-inner">
      ...
      <button className="mt-8 px-6 py-3 bg-primary-purple text-white font-bold rounded-lg shadow-lg transform transition-transform hover:scale-105 hover:shadow-xl">

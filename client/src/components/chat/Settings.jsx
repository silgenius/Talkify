                ...
                {activeSection === 'Account' && (
                    <div className="content">
                        ...
                        <div className="input-section">
                            ...
                            <button className="change-password-button">Confirm Change Password</button>
                        </div>
                    ...
                    <div className="content">
                        ...
                        <div className="privacy-options">
                            <div className="privacy-option">
                                <button className="toggle-button" onClick={() => toggleOptions('lastSeen')}>
                                    {expandedOption === 'lastSeen' ? 'Last seen & Online Options' : 'View Last Seen & Online'}
                                </button>
                            ...
                            <div className="privacy-option">
                                <button className="toggle-button" onClick={() => toggleOptions('profilePhoto')}>
                                    {expandedOption === 'profilePhoto' ? 'Profile Photo Options' : 'View Profile Photo'}
                                </button>
                            ...
                            <div className="privacy-option">
                                <button className="toggle-button" onClick={() => toggleOptions('blockedContacts')}>
                                    {expandedOption === 'blockedContacts' ? 'Blocked Contacts' : 'Blocked Contacts'}
                                </button>
